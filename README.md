...
対話形式で新しいレンズ情報を入力できます：
- 製品名、メーカー、マウントなどを選択式で入力
- IDの自動生成
- ASINの形式検証
- 自動バックアップ作成
...
既存のレンズを選択して削除できます。自動でバックアップも作成されます。

### 詳しい使い方

詳細な管理方法は [MAINTENANCE.md](MAINTENANCE.md) を参照してください。

## コンテンツの追加

### レンズ情報を手動で追加

管理ツールを使わず、直接 `data/lenses.json` を編集することもできます。
